...
{
    public class Cls_Dat_Proveedor : Protected.DataBaseHelper
    {
        ///*********************************************** ----------------- **************************************************/

        ///*********************************************** Lista los  Proveedor *************************************************/

        public List<Cls_Ent_Proveedor> Proveedor_Listar(Cls_Ent_Proveedor entidad_param, ref Cls_Ent_Auditoria auditoria)
        {
            auditoria.Limpiar();
            List<Cls_Ent_Proveedor> lista = new List<Cls_Ent_Proveedor>();
            try
            {
                using (SqlConnection cn = this.GetNewConnection())
                {
                    SqlDataReader dr = null;
                    SqlCommand cmd = new SqlCommand("USP_ADMIN_PROVEEDOR_LISTAR", cn);
                    ...
                    if (dr.HasRows)
                    {
                        Cls_Ent_Proveedor obj = null;
                        while (dr.Read())
                        {
                            obj = new Cls_Ent_Proveedor();
                            if (dr.IsDBNull(pos_ID_PROVEEDOR)) obj.ID_PROVEEDOR = 0;
                            else obj.ID_PROVEEDOR = int.Parse(dr[pos_ID_PROVEEDOR].ToString());
        ...
        public Cls_Ent_Proveedor Proveedor_Listar_Uno(Cls_Ent_Proveedor entidad_param, ref Cls_Ent_Auditoria auditoria)
        {
            auditoria.Limpiar();
            Cls_Ent_Proveedor obj = new Cls_Ent_Proveedor();
            try
            {
                using (SqlConnection cn = this.GetNewConnection())
                {
                    SqlDataReader dr = null;
                    SqlCommand cmd = new SqlCommand("USP_ADMIN_PROVEEDOR_LISTAR_UNO", cn);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@PI_ID_PROVEEDOR", SqlDbType.BigInt)).Value = entidad_param.ID_PROVEEDOR;
                    dr = cmd.ExecuteReader();
                    int pos_ID_PROVEEDOR = dr.GetOrdinal("ID_PROVEEDOR");
                    int pos_NOMBRES_APE = dr.GetOrdinal("NOMBRES_APE");
                    int pos_NUMERO_DOCUMENTO = dr.GetOrdinal("NUMERO_DOCUMENTO");
        ...
        public void Proveedor_Insertar(Cls_Ent_Proveedor entidad, ref Cls_Ent_Auditoria auditoria)
        {
            ...
            try
            {
                using (SqlConnection cn = this.GetNewConnection())
                {
                    SqlCommand cmd = new SqlCommand("USP_ADMIN_PROVEEDOR_INSERTAR", cn);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public void Proveedor_Actualizar(Cls_Ent_Proveedor entidad, ref Cls_Ent_Auditoria auditoria)
        {
            ...
            try
            {
                using (SqlConnection cn = this.GetNewConnection())
                {
                    SqlCommand cmd = new SqlCommand("USP_ADMIN_PROVEEDOR_ACTUALIZAR", cn);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public void Proveedor_Eliminar(Cls_Ent_Proveedor entidad, ref Cls_Ent_Auditoria auditoria)
        {
            ...
            try
            {
                using (SqlConnection cn = this.GetNewConnection())
                {
                    SqlCommand cmd = new SqlCommand("USP_ADMIN_PROVEEDOR_ELIMINAR", cn);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@PI_ID_PROVEEDOR", SqlDbType.Int)).Value = entidad.ID_PROVEEDOR;
                    cmd.Parameters.Add(new SqlParameter("PO_VALIDO", SqlDbType.Int)).Direction = System.Data.ParameterDirection.Output;
                    if (cn.State != System.Data.ConnectionState.Open)
        ...
        public void Proveedor_Estado(Cls_Ent_Proveedor entidad, ref Cls_Ent_Auditoria auditoria)
        {
            ...
            try
            {
                using (SqlConnection cn = this.GetNewConnection())
                {
                    SqlCommand cmd = new SqlCommand("USP_ADMIN_PROVEEDOR_ESTADO", cn);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@PI_ID_PROVEEDOR", SqlDbType.Int)).Value = entidad.ID_PROVEEDOR;
