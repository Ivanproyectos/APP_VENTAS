...
namespace App_Ventas.Areas.Inventario.Controllers
{
    public class ImportarController : Controller
    {
        ...
        public ActionResult Importar_CargarExcel(HttpPostedFileBase fileArchivo, FormCollection forms)
        {
            ...
            if (fileArchivo != null)
            {
                    ...
                    if (EXTENSION.Equals(".xls") || EXTENSION.Equals(".xlsx"))
                    {
                        ...
                        Procesar_CargaMasiva(ruta, ID_SUCURSAL, ref auditoria);
                    }
                    else {
        ...
        private void Procesar_CargaMasiva(string RUTA_ARCHIVO_TEMPORAL, int ID_SUCURSAL, ref Cls_Ent_Auditoria auditoria)
        {
