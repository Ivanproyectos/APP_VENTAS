...
function CuentasCobrar_BuscarProducto(COD_PRODUCTO, ID_SUCURSAL) {
    var item =
       {
    ...
    var url = baseUrl + 'CuentasCobrar/CuentasCobrar/Producto_Buscar_Listar';
...
/*surcut enter*/
function CuentasCobrar_Detalle_Insertar() {
    if (_Valido) {
        if ($('#frmMantenimiento_BuscarProducto').valid()) {
            ...
            if (CuentasCobrar_Detalle_BuscarProducto_Grilla($('#hfd_ID_PRODUCTO').val())) {
