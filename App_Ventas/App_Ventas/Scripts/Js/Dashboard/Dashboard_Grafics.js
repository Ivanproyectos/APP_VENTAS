...
//grafico ventas 
function CargarGrafico_VentasDia(Labels,Data){
   const Ventas_Chart = document.getElementById("Ventas_Chart").getContext('2d');
    //generate gradient
   const Ventas_ChartgradientStroke = Ventas_Chart.createLinearGradient(0, 0, 0, 250);
    Ventas_ChartgradientStroke.addColorStop(0, "rgba(64, 120, 171, 1)");
    Ventas_ChartgradientStroke.addColorStop(1, "rgba(64, 120, 171, 0.5)");
    Ventas_Chart.height = 200;
    new Chart(Ventas_Chart, {
        type: 'horizontalBar',
        data: {
            defaultFontFamily: 'Poppins',
            labels: Labels,
            datasets: [
                {
                    label: "Monto",
                    data: Data,
                    borderColor: Ventas_ChartgradientStroke,
                    borderWidth: "0",
                    backgroundColor: Ventas_ChartgradientStroke, 
                    hoverBackgroundColor:Ventas_ChartgradientStroke
                }
            ]
        },
        options: {
